/*
 * SPI_003_TRANSMIT_HW_SLAVE_MAGEMENT_16BIT.c
 *
...
void SPI2_Init(void)
{
	...
	SPI2Handle.SPI_Config.SPI_SclkSpeed = SPI_SCLK_SPEED_DIV4; //16MHZ / 4 = 4MHz
	SPI2Handle.SPI_Config.SPI_DFF = SPI_DFF_16_BITS;
